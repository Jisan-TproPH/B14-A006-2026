...
const Hero = () => {
    return <div className="flex flex-col md:flex-row p-14 bg-[#222630] rounded-xl gap-6">
        <div className="flex-1 flex flex-col justify-center items-center md:items-start gap-6 md:gap-8 ">
            ...
            <div className="flex gap-4">
                <button className="bg-primary text-black px-6 py-3 rounded-md font-semibold">BROWSE WORKOUTS</button>
            </div>
        </div>
